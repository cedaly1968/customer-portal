...
<td class='list_right'>		 
<input type='text'  value={if $chart_edit_id} '".$post1."[plotoptions][".$plotname."][".$plv[name]."]' {else} '".strip_tags($plv[value])."' {/if}  name='posted_values[plot_options][".$plotname."][".$plv[name]."]' />
</td>
</tr>
</table>		
</li>";
