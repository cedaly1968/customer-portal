...
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/main/address_fields.tpl", 'smarty_include_vars' => array('default_fields' => $this->_tpl_vars['address_fields'],'address' => $this->_tpl_vars['userinfo']['address']['B'],'id_prefix' => 'b_','name_prefix' => "address_book[B]",'zip_section' => 'billing','update_address_book' => 'Y','address_type' => 'B')));
...
unset($_smarty_tpl_vars);
 ?>
  ...
  <?php if ($this->_tpl_vars['config']['Shipping']['need_shipping_section'] == 'Y'): ?>
    ...
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/main/address_fields.tpl", 'smarty_include_vars' => array('default_fields' => $this->_tpl_vars['address_fields'],'address' => $this->_tpl_vars['userinfo']['address']['S'],'id_prefix' => 's_','name_prefix' => "address_book[S]",'zip_section' => 'shipping','update_address_book' => 'Y','address_type' => 'S')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
