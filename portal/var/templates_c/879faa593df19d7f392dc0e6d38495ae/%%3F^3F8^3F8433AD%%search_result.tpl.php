<?php /* Smarty version 2.6.26, created on 2014-04-07 14:39:56
...
:</td>
                <td class="data-input" colspan="2">
                  <select name="posted_data[manufacturers][]" multiple="multiple" class="input-field" size="<?php if ($this->_sections['mnf']['total'] > 5): ?>5<?php else: ?><?php echo $this->_sections['mnf']['total']; ?>
<?php endif; ?>">
...
unset($_smarty_tpl_vars);
 ?>
  ...
  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/dialog.tpl", 'smarty_include_vars' => array('title' => $this->_tpl_vars['lng']['lbl_search_products'],'content' => $this->_smarty_vars['capture']['dialog'],'additional_class' => "adv-search",'noborder' => true,'title_page' => 'category')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
" class="small-link"><?php echo $this->_tpl_vars['lng']['lbl_this_page_url']; ?>
  ...
  <?php $this->_smarty_vars['capture']['dialog'] = ob_get_contents(); ob_end_clean(); ?>
  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/dialog.tpl", 'smarty_include_vars' => array('title' => $this->_tpl_vars['lng']['lbl_products'],'content' => $this->_smarty_vars['capture']['dialog'],'sort' => true,'additional_class' => "products-dialog",'title_page' => 'category')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
