 ...
 ?>
  ...
  <?php if ($this->_tpl_vars['config']['email_as_login'] != 'Y'): ?>
    <tr>
      ...
      <?php if ($this->_tpl_vars['config']['General']['allow_change_login'] != 'Y'): ?>
        <td></td>
        <td>
...
" />
      <?php else: ?>
        <td class="data-required">*</td>
        <td>
          <input type="text" id="uname" name="uname" class="input-required" size="32" maxlength="32" value="<?php if ($this->_tpl_vars['userinfo']['uname']): ?><?php echo $this->_tpl_vars['userinfo']['uname']; ?>
<?php else: ?><?php echo $this->_tpl_vars['userinfo']['login']; ?>
<?php endif; ?>" />
      <?php endif; ?>
      </td>
    </tr>
    ...
    <?php endif; ?>
      ...
      <tr>
        ...
        <td>
          ...
          <label>
            <input type="checkbox" class="exclude-style" id="change_password" name="change_password" value="Y"<?php if ($this->_tpl_vars['userinfo']['change_password'] == 'Y'): ?> checked="checked"<?php endif; ?> />
  ...
  <?php if (( $this->_tpl_vars['userinfo']['usertype'] == 'P' || $_GET['usertype'] == 'P' ) && $this->_tpl_vars['usertype'] == 'A' && $this->_tpl_vars['active_modules']['Simple_Mode'] == ""): ?>
      <tr>
        ...
        <td>
          ...
          <label>
            <input type="checkbox" class="exclude-style" id="trusted_provider" name="trusted_provider" value="Y"<?php if ($this->_tpl_vars['userinfo']['trusted_provider'] == 'Y'): ?> checked="checked"<?php endif; ?> />
