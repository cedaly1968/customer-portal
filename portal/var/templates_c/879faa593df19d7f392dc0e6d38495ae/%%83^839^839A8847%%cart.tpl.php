<?php /* Smarty version 2.6.26, created on 2014-04-20 10:33:55
...
/js/cart.js"></script>
    ...
    <div class="products cart">
      ...
      <form action="cart.php" method="post" name="cartform">
        ...
        <?php $_from = $this->_tpl_vars['products']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['prodcart'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['prodcart']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['product']):
        $this->_foreach['prodcart']['iteration']++;
?>
          <?php if ($this->_tpl_vars['product']['hidden'] == ""): ?>

            <table cellspacing="0" class="width-100 item<?php if (($this->_foreach['prodcart']['iteration'] == $this->_foreach['prodcart']['total'])): ?> last<?php endif; ?>" summary="<?php echo ((is_array($_tmp=$this->_tpl_vars['product']['product'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <?php if ($this->_tpl_vars['main'] == 'checkout'): ?>
          <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/".($this->_tpl_vars['checkout_module'])."/cart_subtotal.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
        <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
            ...
            <div class="button-separator"></div>
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Special_Offers/customer/cart_checkout_buttons.tpl", 'smarty_include_vars' => array('style' => 'link')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
          <?php endif; ?>
