...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'customer/main/buy_now.tpl', 15, false),array('modifier', 'escape', 'customer/main/buy_now.tpl', 26, false),array('modifier', 'substitute', 'customer/main/buy_now.tpl', 79, false),array('function', 'currency', 'customer/main/buy_now.tpl', 115, false),array('function', 'alter_currency', 'customer/main/buy_now.tpl', 116, false),)), $this); ?>
<?php func_load_lang($this, "customer/main/buy_now.tpl","lbl_quantity,txt_out_of_stock,lbl_product_quantity_from_to,txt_out_of_stock,lbl_market_price,lbl_add_to_cart,lbl_add_to_cart,txt_need_min_amount"); ?><div class="buy-now">
...
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/buttons/buy_now.tpl", 'smarty_include_vars' => array('additional_button_class' => "main-button add-to-cart-button",'type' => 'input','button_href' => $this->_tpl_vars['button_href'])));
...
"<?php if ($this->_tpl_vars['smarty_get_quantity'] == $this->_sections['quantity']['index']): ?> selected="selected"<?php endif; ?>><?php echo $this->_sections['quantity']['index']; ?>
    ...
    <?php if ($this->_tpl_vars['product']['appearance']['buy_now_buttons_enabled']): ?>
      ...
      <?php $this->_smarty_vars['capture']['price_button'] = ob_get_contents(); ob_end_clean(); ?>
        ...
        <div class="add-to-cart-row">
          <div class="add-to-cart-layer">
            <div class="button-row">
              <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/buttons/button.tpl", 'smarty_include_vars' => array('type' => 'input','additional_button_class' => "cart-button add-to-cart-button",'button_title' => $this->_smarty_vars['capture']['price_button'],'title' => $this->_tpl_vars['lng']['lbl_add_to_cart'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
            </div>
        ...
        <div class="prices-block"><?php echo $this->_smarty_vars['capture']['price']; ?>
</div>
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <div class="prices-block2"><?php echo $this->_smarty_vars['capture']['price']; ?>
</div>
