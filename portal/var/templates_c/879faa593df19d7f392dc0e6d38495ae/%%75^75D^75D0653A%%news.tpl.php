...
smarty_core_load_plugins(array('plugins' => array(array('insert', 'gate', 'customer/news.tpl', 6, false),array('modifier', 'date_format', 'customer/news.tpl', 25, false),)), $this); ?>
...
echo smarty_core_run_insert_handler(array('args' => array('name' => 'gate', 'func' => 'news_subscription_allowed', 'assign' => 'is_subscription_allowed', 'lngcode' => $this->_tpl_vars['shop_language'])), $this); ?>
    ...
    <td>
      <div class="news-box">
        ...
        <h2 id="news_title"><?php echo $this->_tpl_vars['lng']['lbl_news']; ?>
</h2>
