<?php /* Smarty version 2.6.26, created on 2014-04-08 20:25:19
         compiled from customer/main/register.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'amp', 'customer/main/register.tpl', 66, false),array('modifier', 'escape', 'customer/main/register.tpl', 84, false),array('modifier', 'substitute', 'customer/main/register.tpl', 125, false),array('modifier', 'default', 'customer/main/register.tpl', 185, false),)), $this); ?>
<?php func_load_lang($this, "customer/main/register.tpl","lbl_account_details,lbl_enter_personal_details,lbl_create_profile,txt_modify_profile_msg,txt_anonymous_profile_msg,txt_create_profile_msg,txt_fields_are_mandatory,lbl_go_to_users_list,lbl_register,txt_terms_and_conditions_newbie_note,lbl_delete_profile,lbl_submit_n_checkout,lbl_submit_n_checkout,txt_profile_modified,txt_partner_created,txt_profile_created,txt_newbie_registration_bottom"); ?>
 ...
 ?>
            ...
            <tr>
              ...
              <?php if ($_GET['mode'] == 'update'): ?>
                ...
                <td class="register-button-row"><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/buttons/button.tpl", 'smarty_include_vars' => array('button_title' => $this->_tpl_vars['lng']['lbl_delete_profile'],'href' => "register.php?mode=delete",'style' => 'link','additional_button_class' => "simple-delete-button")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?></td>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php if (((is_array($_tmp=@$this->_tpl_vars['userinfo']['login'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['userinfo']['uname']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['userinfo']['uname'])) == ''): ?>
  ...
  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/dialog.tpl", 'smarty_include_vars' => array('title' => false,'content' => $this->_smarty_vars['capture']['dialog'],'noborder' => true)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
