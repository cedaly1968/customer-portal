...
?>
[16-Mar-2014 08:19:26] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.53.226
    Logged as   : 
...
-------------------------------------------------
[16-Mar-2014 08:20:41] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.53.226
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[16-Mar-2014 08:21:35] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.53.226
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[16-Mar-2014 08:21:45] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.53.226
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[16-Mar-2014 08:22:20] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.53.226
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[16-Mar-2014 08:22:46] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.53.226
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[16-Mar-2014 11:57:41] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 66.249.66.123
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
    Error code  : 1103
    Description : Incorrect table name ''
