...
?>
[18-Mar-2014 09:04:27] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.235.19
    Logged as   : 
...
-------------------------------------------------
[18-Mar-2014 09:05:42] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.235.19
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[18-Mar-2014 09:06:37] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.235.19
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[18-Mar-2014 09:06:47] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.235.19
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[18-Mar-2014 09:07:24] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.235.19
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[18-Mar-2014 09:07:47] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.235.19
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
