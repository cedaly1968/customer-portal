...
?>
[01-Mar-2014 08:07:10] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.203.179
    Logged as   : 
...
-------------------------------------------------
[01-Mar-2014 08:08:14] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.203.179
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[01-Mar-2014 08:09:14] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.203.179
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[01-Mar-2014 08:09:20] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.203.179
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[01-Mar-2014 08:10:00] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.203.179
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
...
-------------------------------------------------
[01-Mar-2014 08:10:24] SQL error:
    Site        : http://portal.dashfacts.com
    Remote IP   : 162.243.203.179
    Logged as   : 
    SQL query   : SELECT * FROM `` where customer_id=''
