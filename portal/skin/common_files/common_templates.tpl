...
{elseif $main eq "hc_create" and $active_modules.HighCharts}
{include file="modules/HighCharts/admin/hc_create.tpl"}

{elseif $main eq "hc_global" and $active_modules.HighCharts}
{include file="modules/HighCharts/admin/hc_global.tpl"}

{elseif $main eq "tablelist" and $active_modules.HighCharts}
{include file="modules/HighCharts/admin/hc_table_list.tpl"}

{elseif $main eq "chartlist" and $active_modules.HighCharts}
{include file="modules/HighCharts/admin/hc_chart_list.tpl"}
