                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            ?>
                            <span class="edit"><a href="#circles_popup_block" rel="circles" class="fancybox_link" title="assign Client Circles" ><?php _e( 'Assign to Client Circles', WPC_CLIENT_TEXT_DOMAIN ) ?></a></span>&nbsp;&nbsp;&nbsp;<span class="edit" id="counter_circles">(<?php echo count($selected_groups); ?>)</span>
