            ...
            <div id="message" class="updated fade" <?php echo ( empty( $error ) )? 'style="display: none;" ' : '' ?> ><?php echo $error; ?></div>
                ...
                <form action="" method="post">
                 <table class="form-table">
                    ...
                    <?php
                    $custom_fields = wpc_client_get_custom_fields();
                    ...
                    <tr>
                        <td>
                            <label>
                                ...
                                <br />
                                <input type="text" style="width: 75px" id="expiration_date" name="expiration_date" value="<?php echo ( $error ) ? esc_html( $_REQUEST['business_name'] ) : '' ?>"/>
                            </label>
