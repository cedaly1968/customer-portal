...
if ( isset( $update_settings ) ) {
    if ( 'login_alerts' == $key ) {
        ...
        $settings['wpc_settings']['new_client_admin_notify']    = ( isset( $wpc_settings['new_client_admin_notify'] ) ) ? '1' : '0';
        $settings['wpc_settings']['send_approval_email']        = ( isset( $wpc_settings['send_approval_email'] ) ) ? '1' : '0';
...
<div class='wrap'>
    ...
    <div id="container23">
        <ul class="menu">
            ...
            <li id="b_info" <?php echo ( isset( $_GET['tab'] ) && 'b_info' == $_GET['tab'] ) ? 'class="active"' : '' ?> ><a href="admin.php?page=wpclients_settings&tab=b_info" ><?php _e( 'Business Info', WPC_CLIENT_TEXT_DOMAIN ) ?></a></li>
            <li id="pages" <?php echo ( isset( $_GET['tab'] ) && 'pages' == $_GET['tab'] ) ? 'class="active"' : '' ?>><a href="admin.php?page=wpclients_settings&tab=pages" ><?php _e( 'Pages', WPC_CLIENT_TEXT_DOMAIN ) ?></a></li>
        ...
        <?php else: ?>
            ...
            <form action="" method="post">
                ...
                ?>
                <div class="postbox">
                    <h3 class='hndle'><span><?php _e( 'Time Limited Clients Settings', WPC_CLIENT_TEXT_DOMAIN ) ?></span></h3>
                    <div class="inside">
                        <table class="form-table">
                            <tr valign="top">
                                <th scope="row">
                                    <label for="wpc_settings_tlc_error_text"><?php _e( 'Error Login Text', WPC_CLIENT_TEXT_DOMAIN ) ?>:</label>
                                </th>
                                <td>
                                    <input type="text" name="wpc_settings[tlc_error_text]" id="wpc_settings_tlc_error_text" value="<?php echo ( isset( $wpc_settings['tlc_error_text'] ) ) ? $wpc_settings['tlc_error_text'] : __( 'Sorry, your access permissions have expired', WPC_CLIENT_TEXT_DOMAIN ) ?>" />
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="inside">
                        <table class="form-table">
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <label>
                                        <input type="checkbox" name="wpc_settings[new_client_admin_notify]" id="wpc_settings_new_client_admin_notify" value="1" <?php echo ( !isset( $wpc_settings['new_client_admin_notify'] ) || '1' == $wpc_settings['new_client_admin_notify'] ) ? 'checked' : '' ?> />
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <label>
                                        <input type="checkbox" name="wpc_settings[send_approval_email]" id="wpc_settings_send_approval_email" value="1" <?php echo ( isset( $wpc_settings['send_approval_email'] ) && '1' == $wpc_settings['send_approval_email'] ) ? 'checked' : '' ?> />
                                        <?php _e( 'Send approval email', WPC_CLIENT_TEXT_DOMAIN ) ?>
                                    </label>
                                </td>
                            </tr>
