            ...
            <?php
                ...
                if ( get_option( 'permalink_structure' ) ) {
                    if ( isset( $logout_redirect ) )
                        $redirect = '?redirect_to=' . $logout_redirect;

                    if ( is_multisite() ) {
                        $link = get_home_url( get_current_blog_id() ) . '/' . wpc_client_get_slug( 'logout' ) . $redirect;
                    } else {
                        $link = get_home_url() . '/' . wpc_client_get_slug( 'logout' ) . $redirect;
                    }
                } else {
                    if ( isset( $logout_redirect ) )
                        $redirect = '&redirect_to=' . $logout_redirect;

                    $link = get_home_url() . '/?wpc_page=logout' . $redirect;
                }
