...
if ( !defined( 'EASYMEDIA_VERSION' ) ) {
	define( 'EASYMEDIA_VERSION', '1.3.1.3' );
}
	        	...
	        	$mediatype = get_post_meta( $post_id, 'easmedia_metabox_media_type', true );
						switch	( $mediatype ) {
								...
								case 'Multiple Images (Slider)':
											 $timthumbimg = EMG_THUMB_FILE . "?src=" . plugins_url( 'images/gallery.png' , __FILE__ ) . "&h=70&w=70&zc=1&q=100";
											 echo '<img class="imgthumblist" width="70" height="70" alt="Thumbnail" src="' . $timthumbimg . '"></img>';
												 break;												
								...
								case 'Google Maps':
											 $timthumbimg = EMG_THUMB_FILE . "?src=" . plugins_url( 'images/maps.png' , __FILE__ ) . "&h=70&w=70&zc=1&q=100";
											 echo '<img class="imgthumblist" width="70" height="70" alt="Thumbnail" src="' . $timthumbimg . '"></img>';
												 break;													 
