...
class Widget_Popular_Posts extends WP_Widget {
	...
	function Widget_Popular_Posts() {
		//Constructor
		$widget_ops = array('classname' => 'widget_popular_posts', 'description' => __( 'Displays the popular posts', 'mandrake_theme' ) );
		$this->WP_Widget('popular_posts', THEME_NAME.' - '.__('Popular Posts', 'mandrake_theme'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		ob_start();
		extract($args);
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Popular Posts', 'mandrake_theme') : $instance['title'], $instance, $this->id_base);
