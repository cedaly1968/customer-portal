...
class Widget_Related_Posts extends WP_Widget {
	...
	function Widget_Related_Posts() {
		//Constructor
		$widget_ops = array('classname' => 'widget_related_posts', 'description' => __( 'Displays the related posts', 'mandrake_theme' ) );
		$this->WP_Widget('related_posts', THEME_NAME.' - '.__('Related Posts', 'mandrake_theme'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		ob_start();
		extract($args);
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Related Posts', 'mandrake_theme') : $instance['title'], $instance, $this->id_base);
