...
<div class="shortcode-wrapper">
    <form name="shortcode-builder" id="blockquote" action="#">
        <div class="description"><label for="blockquote_align">Select Align</label> (optional)</div>
        <div class="options">
            <select id="blockquote_align" name="blockquote_align">
        ...
        <div class="description"><label for="blockquote_cite">Insert Cite</label> (optional)</div>
        <div class="options">
            <input type="text" id="blockquote_cite" name="blockquote_cite" />
        </div>
