...
<div class="shortcode-wrapper">
    <form name="shortcode-builder" id="video_flash" action="#">
    
    	<div class="description"><label for="video_src">Video URL</label></div>
        <div class="options">
        	<input type="text" id="video_src" name="video_src" />
        </div>
