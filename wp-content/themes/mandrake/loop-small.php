<?php
/**
 * The template for displaying blog small image
 */
?>
<?php $display_meta = theme_get_option('blog','display_meta'); ?>
<?php if (have_posts()) while (have_posts()) : the_post(); ?>
	<div class="article left" id="post-<?php the_ID(); ?>" >
        ...
        <div class="article-image">
            <div class="image-holder">
                <div class="image-shadow">
                    <a href="<?php echo get_permalink(); ?>"><?php the_post_thumbnail('blog_small'); ?><span class="zoom-document"></span></a>
