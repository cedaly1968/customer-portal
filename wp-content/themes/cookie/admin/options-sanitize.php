...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'meydjer'),
		'repeat-x'  => __('Repeat Horizontally', 'meydjer'),
		'repeat-y'  => __('Repeat Vertically', 'meydjer'),
		'repeat'    => __('Repeat All', 'meydjer'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'meydjer'),
		'top center'    => __('Top Center', 'meydjer'),
		'top right'     => __('Top Right', 'meydjer'),
		'center left'   => __('Middle Left', 'meydjer'),
		'center center' => __('Middle Center', 'meydjer'),
		'center right'  => __('Middle Right', 'meydjer'),
		'bottom left'   => __('Bottom Left', 'meydjer'),
		'bottom center' => __('Bottom Center', 'meydjer'),
		'bottom right'  => __('Bottom Right', 'meydjer')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'meydjer'),
		'fixed'  => __('Fixed in Place', 'meydjer')
		);
